...
<title>Login &mdash; Hospital Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <p>Manage receptionists and patients in one place. Sign in to access your dashboard.</p>
        <ul class="feature-list">
            <li>&#10003; Admin manages receptionists</li>
            <li>&#10003; Receptionists manage patients</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="auth-foot">Don't have an account?
                <a href="index.php?page=register">Register as Receptionist</a>
            </p>
